...
const Card = () => {
    ...
    return (
        ...
        <div className='bg-white cursor-pointer rounded-lg w-96 h-auto shadow-gray-200 shadow-xl'>
            <figure className='relative'>
                <img className='rounded-tl-2xl rounded-tr-2xl' src="https://images.pexels.com/photos/28055253/pexels-photo-28055253/free-photo-of-diseno-de-cocina.jpeg" />
